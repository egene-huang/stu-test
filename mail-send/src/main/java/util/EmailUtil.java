 ...
 * <br/>
 * User: eugene <br/>
 * Date&Time: 2020/1/12 01:25
 */
public class EmailUtil {

    public static void main(String[] args) {
        try {
            sendEmail01("galaxyforjob@163.com","复杂邮件","自定义图片：<img src='cid:gzh.jpg'/>,网络图片：<img src='http://pic37.nipic.com/20140113/8800276_184927469000_2.png'/>") ;
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
