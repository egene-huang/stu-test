        ...
        while (true) {
            ...
            while (iterator.hasNext()) {
                ...
                if (key.isWritable()) {
                    ...
                    byteBuffer.put(ByteBuffer.wrap(("hello, i'm " + Client2.class.getSimpleName()).getBytes(Server.utf8)));
                    byteBuffer.flip();
                    try {
...
//                                System.out.println("服务器连接失败...");
                    ...
                    try {
                        ...
                        byteBuffer.flip();
                        System.out.println("服务器响应: " + Server.utf8.decode(byteBuffer).toString());
                        //一个回声
